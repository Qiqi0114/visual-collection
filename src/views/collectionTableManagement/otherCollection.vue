...
const exportCollectionTable = async() => {
  ...
  location.href = url.VITE_APP_BASE_API+'/collectionTableService/collectionTable/export_excel_collection?'+'tableId=8&yearId='+exportForm.yearId+'&metId='+exportForm.metId
  loadApplyForUpdateCollectionInfoList();
