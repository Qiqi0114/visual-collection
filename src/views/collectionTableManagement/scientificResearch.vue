<template>
  <div class="container-bg">
    <div class="container">
              ...
              <el-row>
                ...
                <el-col :span="12">
                  <el-form-item style="float: right">
                    ...
                    <el-button @click="deleteXYWoking()" type="success">发布收集表</el-button>
                  </el-form-item>
                </el-col>
              </el-row>
            </el-form>
      ...
      <!--删除对话框-->
      <el-dialog title="添加收集表" v-model="dialogAddFormVisible">
              <el-form :model="addForm">
                <el-row>
                  <el-col :span="10">
                    <el-form-item label="系">
                        <el-select v-model="addForm.searForm.departmentId"
                  ...
                  <el-col :span="8">
                    <el-form-item label="年">
                      <el-select v-model="addForm.searForm.numberYearId" filterable placeholder="请选择">
                        <el-option
                          v-for="item in  YearList.YearListCode"
                          :key="item.value"
                          :label="item.label"
...
import { deleteCollectionTableAPI, saveCollectionTableAPI } from "../../api/collectionTableManagement";
import { deleteXYWokingAPI, getTeachingWokingInfoList, getYearListAPI } from "../../api/teachingwokingload";
